...
class ServiceProvider extends AddonServiceProvider
{
    ...
    private function migrateUserToYaml()
    {
        ...
        if ($config->exists()) {
            ...
            config(['mailchimp.add_new_users' => $config['add_new_users'] ?? false]);
            config(['mailchimp.users' => $config['users'] ?? []]);
